...
export default function PlaceMarker({ place, hasClickAction = true }: Props) {
    ...
    const svgIcon = L.divIcon({
        ...
        html: `
            <svg width="35" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
		...
		s66.516,29.781,66.516,66.531C322.516,210.625,292.734,240.406,256,240.406z"/>
          ...
          `,
        className: 'fill-sky-600 stroke-sky-700 stroke-5', // Optional: for custom styling
        iconSize: [10, 10], // Size of your SVG
        iconAnchor: [25, 44], // Point of the icon corresponding to the marker's location
    })
