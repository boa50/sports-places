...
const iconsData = {
    ...
    // https://www.svgrepo.com/svg/495804/user
    user: {
        viewBox: '0 0 24 24',
        path: [
            'M12 12C14.7614 12 17 9.76142 17 7C17 4.23858 14.7614 2 12 2C9.23858 2 7 4.23858 7 7C7 9.76142 9.23858 12 12 12Z',
            'M12.0002 14.5C6.99016 14.5 2.91016 17.86 2.91016 22C2.91016 22.28 3.13016 22.5 3.41016 22.5H20.5902C20.8702 22.5 21.0902 22.28 21.0902 22C21.0902 17.86 17.0102 14.5 12.0002 14.5Z',
        ],
        strokeWidth: '1',
    },
    // https://www.svgrepo.com/svg/433158/sign-in
    signIn: {
        viewBox: '0 0 24 24',
        path: [
            'm14 15 3-3-3-3',
            'M17 12H3M10 8V5.4A2.4 2.4 0 0 1 12.4 3h6.2A2.4 2.4 0 0 1 21 5.4v13.2a2.4 2.4 0 0 1-2.4 2.4h-6.2a2.4 2.4 0 0 1-2.4-2.4V16',
        ],
        strokeWidth: '1.5',
    },
    // https://www.svgrepo.com/svg/433162/sign-out
    signOut: {
        viewBox: '0 0 24 24',
        path: [
            'm18 15 3-3-3-3',
            'M21 12H7M14 16v2.6a2.4 2.4 0 0 1-2.4 2.4H5.4A2.4 2.4 0 0 1 3 18.6V5.4A2.4 2.4 0 0 1 5.4 3h6.2A2.4 2.4 0 0 1 14 5.4V8',
        ],
        strokeWidth: '1.5',
    },
}
